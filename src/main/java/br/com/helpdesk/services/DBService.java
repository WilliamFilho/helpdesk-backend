...
public class DBService {
    ...
    public void instanciaDB() {
        Tecnico tec1 = new Tecnico(null, "William Filho", "90790324334", "williamfilho20@gmail.com", encoder.encode("123"));
        tec1.addPerfil(Perfil.ADMIN);

        Tecnico tec2 = new Tecnico(null, "Patricia Franco Sousa", "89529588372", "patricia@gmail.com", encoder.encode("123"));

        Cliente cli1 = new Cliente(null, "Bill Gates", "25463515670", "bill@gmail.com", encoder.encode("123"));
